...
- (RCPaywallViewController * _Nonnull)createPaywallViewWithOfferingIdentifier:(NSString * _Nonnull)offeringIdentifier SWIFT_WARN_UNUSED_RESULT;
- (RCPaywallFooterViewController * _Nonnull)createFooterPaywallView SWIFT_WARN_UNUSED_RESULT;
- (RCPaywallFooterViewController * _Nonnull)createFooterPaywallViewWithOfferingIdentifier:(NSString * _Nonnull)offeringIdentifier SWIFT_WARN_UNUSED_RESULT;
