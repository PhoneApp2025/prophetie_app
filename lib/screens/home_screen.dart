...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<List<String>> _findSimilarProphecies(
    List<Prophetie> prophetien,
  ) async {
    final apiKey = 'sk-be05e908545143059ccfc7ab3952e269';
    final prompt =
        '''
Du bekommst eine Liste von prophetischen Eindrücken. Deine Aufgabe ist es **ausschließlich** solche Prophetien zu erkennen, die thematisch zusammenhängen – z. B. wenn Gott ein Thema (z. B. „Berufung in Afrika“) bereits früher angesprochen hat und nun erneut.

Beziehe dich dabei auf Formulierungen, Themen oder Begriffe, die sich wiederholen, ergänzen oder aufeinander verweisen.

Antwortformat:
- Fasse keine allgemeinen Inhalte zusammen!
- Zeige nur Prophetien auf, die durch Wiederholung oder Weiterführung miteinander verbunden sind.

Prophetien:
${prophetien.map((p) => "- ${p.transcript} (${p.timestamp.toIso8601String()})").join('\n')}

Thematische Wiederholungen und Zusammenhänge:
''';
        ...
        'messages': [
          {
            'role': 'system',
            'content':
                'Du bist ein Assistent. Du hilfst, wiederkehrende Themen in Prophetien zu erkennen.',
          },
    ...
    if (response.statusCode == 200) {
      ...
      print("Fehler bei KI: ${response.body}");
      return ["Fehler bei der Ähnlichkeitssuche."];
    }
  }
