  ...
  Future<bool> _reauthenticateUser() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text('Fehler bei der Bestätigung: $e')));
      return false;
    }
  }
                  ...
                  ListTile(
                    ...
                    trailing: DropdownButton<String>(
                      ...
                      items: const [
                        ...
                        DropdownMenuItem(value: 'light', child: Text('Day')),
                        DropdownMenuItem(value: 'dark', child: Text('Night')),
                      ],
                    ),
                  ),
                  Divider(
                    ...
                    onTap: () async {
                      ...
                      if (shouldChange) {
                        ...
                        try {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(content: Text('Fehler beim Ändern: $e')),
                          );
                        }
                      }
                    },
                  ...
                  ListTile(
                    ...
                    onTap: () async {
                      ...
                      if (await canLaunchUrl(emailUri)) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text('Konnte E-Mail-App nicht öffnen'),
                          ),
                        );
                      }
                    },
                  ...
                  ListTile(
                    ...
                    onTap: () async {
                      ...
                      if (user == null) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text('Kein eingeloggter Nutzer gefunden'),
                          ),
                        );
                        return;
                      }
