        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              padding: const EdgeInsets.fromLTRB(16, 0, 16, 8),
              child: Text(
                'Warum kostet die App 25€ im Jahr?',
                style: TextStyle(
                  fontSize: 14,
                  fontWeight: FontWeight.w600,
                  color:
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    const SizedBox(height: 0),
                    Text(
                      'Die jährliche Gebühr von 25 € dient nicht dem Profit. Sie deckt nicht annähernd die realen Kosten der App, sondern soll eine kleine Unterstützung sein, um das Projekt überhaupt am Leben zu erhalten.\n\n'
