      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              // Labels und Suchleiste in einer Zeile
              Padding(
                padding: const EdgeInsets.only(bottom: 4.0, top: 38.0),
                child: Row(
                  children: [
                  ...
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: Chip(
                        ...
                        label: Text(
                          p.labels.isNotEmpty ? p.labels.first : '',
