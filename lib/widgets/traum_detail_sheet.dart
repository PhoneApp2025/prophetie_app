...
class _TraumDetailSheetState extends State<TraumDetailSheet> {
  ...
  // Local labels for immediate UI feedback
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<DocumentSnapshot<Map<String, dynamic>>>(
      ...
      builder: (ctx, snapshot) {
        ...
        // Initialize local labels once for immediate updates
        if (_currentLabels.isEmpty) {
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    // Label selection UI with local state for immediate feedback
                          ...
                          builder: (ctx2, setChipState) {
                            return Wrap(
                              ...
                              children: labelDocs.map((labelDoc) {
                                ...
                                final isSelected = _currentLabels.contains(
                                  label,
                                );
                                return FilterChip(
                                  label: Text(
