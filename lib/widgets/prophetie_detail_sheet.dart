...
class _ProphetieDetailSheetState extends State<ProphetieDetailSheet> {
  ...
  Future<void> _loadProphetie() async {
    ...
    if (ts != null) {
      _dateController.text = DateFormat('dd.MM.yyyy').format(ts.toDate());
    }
                        ...
                        IconButton(
                          ...
                          onPressed: () async {
                            ...
                            if (transcriptText != null &&
                              ...
                              // Direkt analysieren, wenn Transkript vorhanden
                              ...
                              // Falls kein Transkript, erst Audio transkribieren und dann analysieren
                              ...
                              if (filePath != null && filePath.isNotEmpty) {
                                ...
                                // Fehlermeldung, wenn weder Transkript noch Audio vorhanden
                                Navigator.of(
                                  context,
